...
<head>
    ...
    <title>NexusCRM - Enterprise Customer Relationship Management</title>
...
<body class="bg-slate-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="#benefits" class="text-slate-600 hover:text-blue-600 font-medium transition-colors">Keunggulan</a>
                    <a href="#testimonials" class="text-slate-600 hover:text-blue-600 font-medium transition-colors">Testimoni</a>
                </div>
                <div class="flex items-center gap-4">
                    <a href="{{ route('login') }}" class="text-slate-600 hover:text-slate-900 font-medium transition-colors">Login</a>
                    <a href="{{ route('login') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg font-semibold transition-all duration-200 shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50">
                        Mulai Sekarang
                    </a>
                </div>
            </div>
    ...
    <!-- Hero Section -->
    <section class="gradient-bg pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <!-- Background Decorations -->
            <div class="absolute top-20 right-0 w-96 h-96 bg-blue-500/20 rounded-full blur-3xl"></div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center relative z-10">
                <div class="text-white">
                    <div class="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6 border border-white/20">
                        ...
                        <span class="text-sm font-medium">Platform CRM #1 untuk Bisnis Indonesia</span>
                    </div>
                    <h1 class="text-4xl lg:text-6xl font-bold leading-tight mb-6">
                        Kelola Hubungan Pelanggan dengan Lebih <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Cerdas & Efisien</span>
                    </h1>
                    <p class="text-lg text-slate-300 mb-8 leading-relaxed">
                        Platform all-in-one untuk tim sales, support, dan manajemen. Pantau pipeline penjualan, kelola invoice, otomatisasi tugas, dan tingkatkan produktivitas dalam satu dashboard terintegrasi.
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="{{ route('login') }}" class="inline-flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-200 shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 hover:-translate-y-1">
                            <ion-icon name="log-in-outline" class="text-xl"></ion-icon>
                            Coba Demo Gratis
                        </a>
                        <a href="#features" class="inline-flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-200 backdrop-blur-sm border border-white/20">
                    ...
                    <div class="grid grid-cols-3 gap-6 mt-12 pt-8 border-t border-white/10">
                        <div>
                            ...
                            <div class="text-sm text-slate-400">Perusahaan Terpercaya</div>
                        </div>
                        <div>
                            <div class="text-3xl font-bold text-white">98%</div>
                            <div class="text-sm text-slate-400">Kepuasan Pelanggan</div>
                        </div>
                        <div>
                            <div class="text-3xl font-bold text-white">24/7</div>
                            <div class="text-sm text-slate-400">Support Prioritas</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative">
                    <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-2xl">
                        <div class="bg-slate-900 rounded-xl overflow-hidden">
                            ...
                            <div class="bg-slate-800 px-4 py-3 flex items-center gap-2 border-b border-slate-700">
                                ...
                                <div class="ml-4 text-xs text-slate-400">dashboard.nexuscrm.com</div>
                            </div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="bg-slate-800/50 rounded-lg p-4 border border-slate-700">
                                        <div class="flex items-center gap-2 mb-2">
                                            ...
                                            <span class="text-xs text-slate-400">Total Leads</span>
                                        </div>
                                        <div class="text-2xl font-bold text-white">1,247</div>
                                        <div class="text-xs text-green-400 flex items-center gap-1">
                                            <ion-icon name="trending-up"></ion-icon> +12.5%
                                        </div>
                                    </div>
                                    <div class="bg-slate-800/50 rounded-lg p-4 border border-slate-700">
                                        <div class="flex items-center gap-2 mb-2">
                                            <ion-icon name="cash-outline" class="text-green-400"></ion-icon>
                                            <span class="text-xs text-slate-400">Revenue</span>
                                        </div>
                                        <div class="text-2xl font-bold text-white">Rp 2.4M</div>
                                        <div class="text-xs text-green-400 flex items-center gap-1">
                                            <ion-icon name="trending-up"></ion-icon> +8.2%
                                        </div>
                                    </div>
                                </div>
                                <div class="bg-slate-800/50 rounded-lg p-4 border border-slate-700">
                                    <div class="flex items-center justify-between mb-3">
                                        <span class="text-xs text-slate-400">Pipeline Sales</span>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex items-center justify-between text-xs">
                                            <span class="text-slate-300">Negotiation</span>
                                        ...
                                        <div class="flex items-center justify-between text-xs">
                                            <span class="text-slate-300">Won</span>
    ...
    <section id="features" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <span class="text-blue-600 font-semibold text-sm uppercase tracking-wider">Fitur Lengkap</span>
                <h2 class="text-3xl lg:text-4xl font-bold text-slate-900 mt-2 mb-4">Semua yang Anda Butuhkan untuk Tumbuh</h2>
                <p class="text-slate-600 text-lg">Platform CRM komprehensif dengan 15+ modul terintegrasi untuk mengoptimalkan setiap aspek bisnis Anda.</p>
            </div>
            
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Feature 1 -->
                <div class="group p-6 rounded-2xl bg-slate-50 hover:bg-white border border-slate-100 hover:border-blue-200 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300">
                    <div class="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-blue-500 transition-colors">
                        <ion-icon name="funnel-outline" class="text-2xl text-blue-600 group-hover:text-white transition-colors"></ion-icon>
                    </div>
                    <h3 class="text-xl font-bold text-slate-900 mb-2">Pipeline Kanban</h3>
                    <p class="text-slate-600">Visualisasikan proses penjualan dengan board Kanban interaktif. Track leads dari awal hingga closing.</p>
                </div>
                
                <!-- Feature 2 -->
                <div class="group p-6 rounded-2xl bg-slate-50 hover:bg-white border border-slate-100 hover:border-green-200 hover:shadow-xl hover:shadow-green-500/10 transition-all duration-300">
                    <div class="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-green-500 transition-colors">
                        <ion-icon name="document-text-outline" class="text-2xl text-green-600 group-hover:text-white transition-colors"></ion-icon>
                    </div>
                    <h3 class="text-xl font-bold text-slate-900 mb-2">Digital Invoice</h3>
                    <p class="text-slate-600">Buat dan kirim invoice profesional secara digital. Tracking pembayaran real-time dengan status otomatis.</p>
                </div>
                
                <!-- Feature 3 -->
                <div class="group p-6 rounded-2xl bg-slate-50 hover:bg-white border border-slate-100 hover:border-purple-200 hover:shadow-xl hover:shadow-purple-500/10 transition-all duration-300">
                    <div class="w-12 h-12 bg-purple-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-purple-500 transition-colors">
                        <ion-icon name="people-outline" class="text-2xl text-purple-600 group-hover:text-white transition-colors"></ion-icon>
                    </div>
                    <h3 class="text-xl font-bold text-slate-900 mb-2">Client Management</h3>
                    <p class="text-slate-600">Database klien terpusat dengan riwayat interaksi lengkap. Never miss a follow-up lagi.</p>
                </div>
                
                <!-- Feature 4 -->
                <div class="group p-6 rounded-2xl bg-slate-50 hover:bg-white border border-slate-100 hover:border-orange-200 hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-300">
                    <div class="w-12 h-12 bg-orange-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-orange-500 transition-colors">
                        <ion-icon name="calendar-outline" class="text-2xl text-orange-600 group-hover:text-white transition-colors"></ion-icon>
                    </div>
                    <h3 class="text-xl font-bold text-slate-900 mb-2">Smart Calendar</h3>
                    <p class="text-slate-600">Jadwalkan meeting, call, dan follow-up dalam satu kalender terintegrasi dengan reminder otomatis.</p>
                </div>
                
                <!-- Feature 5 -->
                <div class="group p-6 rounded-2xl bg-slate-50 hover:bg-white border border-slate-100 hover:border-red-200 hover:shadow-xl hover:shadow-red-500/10 transition-all duration-300">
                    <div class="w-12 h-12 bg-red-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-red-500 transition-colors">
                        <ion-icon name="chatbubble-ellipses-outline" class="text-2xl text-red-600 group-hover:text-white transition-colors"></ion-icon>
                    </div>
                    <h3 class="text-xl font-bold text-slate-900 mb-2">Ticketing System</h3>
                    <p class="text-slate-600">Kelola support ticket pelanggan dengan prioritas dan tracking status yang jelas.</p>
                </div>
                
                <!-- Feature 6 -->
                <div class="group p-6 rounded-2xl bg-slate-50 hover:bg-white border border-slate-100 hover:border-cyan-200 hover:shadow-xl hover:shadow-cyan-500/10 transition-all duration-300">
                    <div class="w-12 h-12 bg-cyan-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-cyan-500 transition-colors">
                        <ion-icon name="bar-chart-outline" class="text-2xl text-cyan-600 group-hover:text-white transition-colors"></ion-icon>
                    </div>
                    <h3 class="text-xl font-bold text-slate-900 mb-2">Analytics & Reports</h3>
                    <p class="text-slate-600">Dashboard analitik dengan leaderboard tim, win-rate tracking, dan insight bisnis mendalam.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="benefits" class="py-20 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                    <span class="text-blue-600 font-semibold text-sm uppercase tracking-wider">Mengapa NexusCRM?</span>
                    <h2 class="text-3xl lg:text-4xl font-bold text-slate-900 mt-2 mb-6">Lebih dari Sekadar CRM Biasa</h2>
                    <p class="text-slate-600 text-lg mb-8">Dibangun khusus untuk kebutuhan bisnis Indonesia dengan fitur yang benar-benar digunakan sehari-hari.</p>
                    ...
                    <div class="space-y-6">
                        <div class="flex gap-4">
                            ...
                            <div>
                                <h3 class="font-bold text-slate-900 mb-1">Multi-Role Access</h3>
                                <p class="text-slate-600">Sistem permission berbasis role (Admin, Manager, Agent) untuk keamanan data optimal.</p>
                            </div>
                        </div>
                        
                        <div class="flex gap-4">
                            <div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center flex-shrink-0">
                                <ion-icon name="speedometer-outline" class="text-2xl text-blue-600"></ion-icon>
                            </div>
                            <div>
                                <h3 class="font-bold text-slate-900 mb-1">Lightning Fast</h3>
                                <p class="text-slate-600">Arsitektur monolitik yang dioptimalkan untuk kecepatan maksimal tanpa kompleksitas unnecessary.</p>
                            </div>
                        </div>
                        
                        <div class="flex gap-4">
                            <div class="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center flex-shrink-0">
                                <ion-icon name="shield-checkmark-outline" class="text-2xl text-purple-600"></ion-icon>
                            </div>
                            <div>
                                <h3 class="font-bold text-slate-900 mb-1">Enterprise Security</h3>
                                <p class="text-slate-600">Data terenkripsi dengan standar keamanan enterprise grade untuk perlindungan maksimal.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative">
                    <div class="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-500 rounded-3xl transform rotate-3 opacity-20"></div>
                    <div class="relative bg-white rounded-3xl shadow-2xl p-8 border border-slate-100">
                        <div class="space-y-6">
                            <div class="flex items-center justify-between pb-4 border-b border-slate-100">
                                <div>
                                    <div class="text-sm text-slate-500">Total Revenue Bulan Ini</div>
                                    <div class="text-3xl font-bold text-slate-900">Rp 4.284.500.000</div>
                                </div>
                                <div class="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center">
                                    <ion-icon name="trending-up" class="text-2xl text-green-600"></ion-icon>
                                </div>
                            </div>
                            
                            <div class="space-y-4">
                                <div class="flex items-center justify-between">
                                    <span class="text-slate-600">Leads Baru</span>
                                    <span class="font-semibold text-slate-900">+124</span>
                                </div>
                                ...
                                <div class="flex items-center justify-between">
                                    <span class="text-slate-600">Proposal Dikirim</span>
                                    <span class="font-semibold text-slate-900">48</span>
                                </div>
                                <div class="w-full bg-slate-100 rounded-full h-2">
                                ...
                                <div class="flex items-center justify-between">
                                    <span class="text-slate-600">Deal Won</span>
                                    <span class="font-semibold text-slate-900">23</span>
                                </div>
                                <div class="w-full bg-slate-100 rounded-full h-2">
                            ...
                            <div class="pt-4 border-t border-slate-100">
                                <div class="flex items-center gap-3">
                                    <div class="flex -space-x-2">
                                        ...
                                        <div class="w-8 h-8 rounded-full border-2 border-white bg-slate-100 flex items-center justify-center text-xs font-medium text-slate-600">+12</div>
                                    </div>
                                    <span class="text-sm text-slate-600">Tim sales aktif hari ini</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section id="testimonials" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <h2 class="text-3xl lg:text-4xl font-bold text-slate-900 mt-2 mb-4">Dipercaya oleh Ribuan Bisnis</h2>
                <p class="text-slate-600 text-lg">Lihat apa kata mereka tentang NexusCRM.</p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="p-6 rounded-2xl bg-slate-50 border border-slate-100">
                    ...
                    <p class="text-slate-600 mb-6">"Sejak menggunakan NexusCRM, tim sales kami meningkat 40%. Pipeline visualization sangat membantu tracking deals."</p>
                    <div class="flex items-center gap-3">
                        <img class="w-10 h-10 rounded-full" src="https://i.pravatar.cc/100?img=11" alt="">
                        <div>
                            <div class="font-semibold text-slate-900">Andi Pratama</div>
                            <div class="text-sm text-slate-500">CEO, TechStart Indonesia</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 rounded-2xl bg-slate-50 border border-slate-100">
                    ...
                    <p class="text-slate-600 mb-6">"Invoice digital dan tracking payment jadi jauh lebih mudah. Tidak ada lagi tagihan yang terlewat!"</p>
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-slate-500">Finance Manager, Digital Solutions</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 rounded-2xl bg-slate-50 border border-slate-100">
                    ...
                    <p class="text-slate-600 mb-6">"Support ticket system membantu kami maintain customer satisfaction di level tertinggi. Recommended!"</p>
                    <div class="flex items-center gap-3">
                        <img class="w-10 h-10 rounded-full" src="https://i.pravatar.cc/100?img=8" alt="">
                        <div>
                            <div class="font-semibold text-slate-900">Budi Santoso</div>
                            <div class="text-sm text-slate-500">Operations Director, ServicePro</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-20 gradient-bg">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-3xl lg:text-4xl font-bold text-white mb-6">Siap Meningkatkan Bisnis Anda?</h2>
            <p class="text-lg text-slate-300 mb-8">Bergabunglah dengan 2,000+ perusahaan yang telah mempercayakan manajemen customer mereka pada NexusCRM.</p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('login') }}" class="inline-flex items-center justify-center gap-2 bg-white hover:bg-slate-100 text-slate-900 px-8 py-4 rounded-xl font-semibold transition-all duration-200 shadow-lg hover:-translate-y-1">
                    <ion-icon name="log-in-outline" class="text-xl"></ion-icon>
                    Login Sekarang
                </a>
                <a href="#" class="inline-flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-200 backdrop-blur-sm border border-white/20">
    ...
    <footer class="bg-slate-900 pt-16 pb-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-4 gap-8 mb-12">
                <div class="col-span-1">
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <span class="text-xl font-bold text-white">Nexus<span class="text-blue-400">CRM</span></span>
                    </div>
                    <p class="text-slate-400 text-sm">Platform CRM all-in-one untuk bisnis modern Indonesia.</p>
                </div>
            ...
            <div class="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-slate-500 text-sm">&copy; {{ date('Y') }} NexusCRM. All rights reserved.</p>
                <div class="flex gap-4">
