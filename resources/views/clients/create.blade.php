<x-layout.app>
    <x-slot name="title">Tambah Klien Baru</x-slot>
    <x-slot name="subtitle">Tambahkan klien baru ke sistem</x-slot>
    ...
    <x-ui.card>
        <form action="{{ route('clients.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex justify-end space-x-3 pt-6 border-t border-slate-200">
                <x-ui.button href="{{ route('clients.index') }}" variant="secondary">
                    Batal
                </x-ui.button>
