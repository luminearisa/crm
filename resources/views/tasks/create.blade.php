<x-layout.app>
    <x-slot name="title">Tambah Tugas Baru</x-slot>
    <x-slot name="subtitle">Buat tugas baru untuk dikerjakan</x-slot>
    ...
    <x-ui.card>
        <form action="{{ route('tasks.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Status -->
                <div>
                    <label for="status" class="block text-sm font-medium text-slate-700 mb-2">Status Awal</label>
